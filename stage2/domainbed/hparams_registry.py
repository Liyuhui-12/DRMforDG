...
def _hparams(algorithm, dataset, random_seed):
    ...
    """
    SMALL_IMAGES = ['Debug28', 'RotatedMNIST', 'ColoredMNIST','DSprites', 'dshapes']
    ...
    _hparam('match_data', 1.0, lambda r: r.uniform(0, 1))
    ...
    elif algorithm == "VREx2":
        _hparam('vrex2_lambda', 1e1, lambda r: 10**r.uniform(-1, 5))
        _hparam('vrex2_penalty_anneal_iters', 500,
                lambda r: int(10**r.uniform(0, 4)))
    ...
    if dataset in SMALL_IMAGES:
        ...
        _hparam('batch_size', 16, lambda r: int(2 ** r.uniform(2, 4.5)))
