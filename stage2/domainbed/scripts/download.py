...
def download_and_extract(url, dst, remove=True,download=True):
...
def download_terra_incognita(data_dir):
    ...
    download_and_extract(
        ...
        os.path.join(full_path, "terra_incognita_images.tar.gz"),download=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', type=str, default='./data0')
    ...
    #
    # print('office home finished!!!')
    #
    # download_domain_net(args.data_dir)
    #
    # print('domainnet finished!!!')
    #
