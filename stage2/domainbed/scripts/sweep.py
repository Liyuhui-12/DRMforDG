        ...
        for dataset in dataset_names:
            for algorithm in algorithms:
                ...
                for test_envs in all_test_envs:
                    if args.final_testenv==None:
                        fenvlist = test_envs
                    else:
                        fenvlist = args.final_testenv

                    for fenv in fenvlist:
                        print('fenvlist',fenvlist)
                        if fenv not in test_envs:
                            continue
                        for hparams_seed in range(n_hparams_from, n_hparams):
                            train_args = {}
                            train_args['fenv'] = fenv
...
if __name__ == "__main__":
    ...
    parser.add_argument('--final_testenv', type=int, nargs='+')
    parser.add_argument('--datasets', nargs='+', type=str, default=["ColoredMNIST"])
    ...
    parser.add_argument('--output_dir', type=str, default='out0')
    parser.add_argument('--data_dir', type=str, default='D:\ood\code\DomainBed\data0')
    parser.add_argument('--seed', type=int, default=0)
    parser.add_argument('--n_trials', type=int, default=3)
    parser.add_argument('--command_launcher', type=str, default='dummy')
